...
it <- 50  # Número de iterações
control <- list(maxit = it)

resultado <- psoptim(par = NULL, lower = lower, upper = upper, fn = eval, control = control, npop = n, swarmsize = n)
...
print(paste("Melhor lucro obtido:", -resultado$value))  # Avaliação da melhor solução