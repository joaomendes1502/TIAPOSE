...
# Function to convert binary to real values
...
# Objective function as defined previously
...
# Function to calculate upper bounds
...
# Tabu Search Optimization Function
tabuo2_optimizar <- function(previsoes_vendas) {
  lower <- rep(0, 28)
  ...
  tabu_eval <- function(x) {
    eval_function(x, BITS, lower, upper, eval_fn, previsoes_vendas)
  }
