...
evalf3=function(s) return(eval(s)$objective)
...
resultado <- mcsearch(fn = function(s) eval(s, previsoes_vendas)$objective, lower = lower, upper = upper, N = N, type = "min")
...
final_results <- eval(melhor_solucao, previsoes_vendas)

# Imprimir os resultados
print(paste("Lucro do mês:", -final_results$profit))
print(paste("Esforço total:", final_results$effort))
